package rw.pacis.tekanaewallet.security.service.impl;
...
import rw.pacis.tekanaewallet.utils.AuthTokenWrapper;
...
public class JwtServiceImpl implements IJwtService {
    ...
    private String generateToken(Map<String, Object> extraClaims, UserDetails userDetails) {
        ...
        UserAccount userById = userRepository.findByEmail(userDetails.getUsername()).get();
